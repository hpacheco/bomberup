module Page.Editor.Data.Status exposing
  ( Status(..)
  , getProblems, hasProblems, withProblems, isCompiling
  , changed, compiling, success, problems, boolToStatus
  )
...
import Page.Editor.Data.Problem as Problem exposing (Problem, Problems)

boolToStatus : Bool -> Status
boolToStatus isSuccess = if isSuccess then Success else Changed
